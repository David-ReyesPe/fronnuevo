...
function EditProfileModal({ perfil, isOpen, onClose, onSave }) {
  ...
  const handleFileChange = (event) => {
    ...
    reader.onload = (event) => {
      ...
      // Now set the image in editedPerfil
      setEditedPerfil({
        ...editedPerfil,
        imagen: encodedData,
      });
  ...
  const handleSaveClick = () => {
    const editedPerfilWithImage = {
      ...editedPerfil,
      imagen: encodedImage  // Asegúrate de incluir la imagen codificada en el perfil
    };
    onSave(editedPerfil,editedPerfilWithImage); // Llama a la función onSave con el perfil editado y la imagen seleccionada
